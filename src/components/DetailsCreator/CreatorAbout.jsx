  ...
  return (
    <div className="about-container">
      ...
      <p className="detail-desc">
        Hideo Kojima is a Japanese video game designer, director, writer, and
        producer. He is the founder and head of Kojima Productions. Widely
        regarded as one of the greatest game designers of all time, Kojima is
        best known for creating the Metal Gear franchise and Death Stranding.
      </p>
      <p className="detail-desc">
        Throughout his career, Kojima has pioneered cinematic storytelling in
        games, pushing the medium toward high-concept narratives that explore
        themes of nuclear deterrence, the nature of identity, and human
        connection. His work has consistently received critical acclaim and
        commercial success.
      </p>
